                ...
                <div class="col-md-12 col-lg-12">
                    <div class="row">
                        <div class="col-md-12 col-lg-3">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title text-uppercase m-t-10">DRAG AND DROP YOUR EVENT</h5>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="checkbox m-t-10">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="customCheck1"> Remove After Drop </label>
                                                </div>
                                            </div>
                                            <a href="javascript:void(0)" data-toggle="modal" data-target="#add-new-event" class="btn m-t-40 btn-primary btn-block waves-effect waves-light">
